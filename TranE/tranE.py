...
class TransE:
    def __init__(self, entityList, relationList, tripleList, margin = 1, learingRate = 0.00001, dim = 512, L1 = True):
        self.margin = margin
    ...
    def transE(self, cI = 20):
        ...
        for cycleIndex in range(cI):
            ...
            if cycleIndex % 100 == 0:
                ...
                print(self.loss)
                self.writeRelationVector("./relationVector")
                self.writeEntilyVector("./entityVector")
                self.loss = 0
...
if __name__ == '__main__':
    ...
    transE.initialize()
    transE.transE(15000)
    transE.writeRelationVector("./relationVector")
    transE.writeEntilyVector("./entityVector")
